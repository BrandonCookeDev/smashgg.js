        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        player1 = Player_1.Player.parse(testData.player1Data);
                        player2 = Player_1.Player.parse(testData.player2Data);
                        player3 = Player_1.Player.parse(testData.player3Data);
