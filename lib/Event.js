...
class Event extends EventEmitter{
    ...
    constructor(eventId, tournamentId=undefined, expands=undefined, isCached=true){
        super();
    ...
    // Convenience methods    
    static getEvent(eventName, tournamentName, expands=undefined, isCached=true){
        let deferred = when.defer();
        try{
            let E = new Event(eventName, tournamentName, expands, isCached);
            E.on('ready', function(){
                deferred.resolve(E);
            })
    ...
    static getEventById(id, expands=undefined, isCached=true){
        ...
        try{
            ...
            let E = new Event(id, undefined, expands, isCached);
            E.on('ready', function(){
                deferred.resolve(E);
            })
            E.on('error', function(e){
    ...
    async getEventPhases(fromCacheTF){
        ...
        try{
            ...
            let allPhases = await Promise.all(
                this.data.entities.phase.map(async (phase) => {
