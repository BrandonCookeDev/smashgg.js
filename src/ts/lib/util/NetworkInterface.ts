...
import {ITournament, IEvent, IPlayer, IGGSet, IPhase, IPhaseGroup} from '../internal'
...
export default class NetworkInterface{
	...
	static async getTournamentFromV1(tournamentName: string, options: ITournament.Options){
