...
var User = /** @class */ (function () {
    ...
    User.parse = function (data) {
        return new User(data.data.player.id, data.data.player.gamerTag, data.data.player.prefix, data.data.player.color, data.data.player.twitchStream, data.data.player.twitterHandle, data.data.player.youtube, data.data.player.region, data.data.player.state, data.data.player.country, data.data.player.gamerTagChangedAt);
    };
    User.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, NetworkInterface_1.default.query(queries.user, { id: id })];
                    case 1:
                        data = _a.sent();
    ...
    User.prototype.getRecentSets = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, NetworkInterface_1.default.query(queries.userRecentGGSets, { id: this.id })];
                    case 1:
                        data = _a.sent();
                        sets = data.data.player.recentSets.map(function (setData) { return internal_1.GGSet.parse(setData); });
    ...
    User.prototype.getRankings = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, NetworkInterface_1.default.query(queries.userRankings, { id: this.id })];
                    case 1:
                        data = _a.sent();
                        rankings = data.data.player.rankings;
