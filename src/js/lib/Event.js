...
var Event = /** @class */ (function (_super) {
    ...
    function Event(id, name, slug, tournamentId, tournamentName, tournamentSlug, data, options, state, startAt, numEntrants, checkInBuffer, checkInDuration, checkInEnabled, isOnline, teamNameAllowed, teamManagementDeadline) {
        ...
        _this.tournamentSlug = tournamentSlug;
        _this.data = Encoder_1.default.encode(data, options.rawEncoding);
        _this.rawEncoding = Encoder_1.default.determineEncoding(options.rawEncoding);
