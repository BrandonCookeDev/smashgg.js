...
const TOURNAMENT_NAME1 = '21xx-cameron-s-birthday-bash-1'
...
describe('Smash GG Tournament', function(){
	...
	it('should return the correct starting time', function(done){
		...
		let expected1 = moment('07-21-2018 18:00:00', 'MM-DD-YYYY HH:mm:ss').toDate()
	...
	it('should return the correct end time', function(done){
		...
		let expected1 = moment('07-21-2018 23:59:00', 'MM-DD-YYYY HH:mm:ss').toDate()
	...
	it('should resolve the correct number of sets x minutes ago', async function(){
		...
		let tournamentDate = moment('06-21-2018 18:00:00', 'MM-DD-YYYY HH:mm:ss').add(30, 'minutes').toDate()
